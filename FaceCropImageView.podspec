#
# Be sure to run `pod lib lint FaceCropImageView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'This FaceCropImageView is the extension of UIImageView that crops and shows the proper location of face in the photo.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'FaceCropImageView' => ['FaceCropImageView/Assets/*.png']
  # }
